                    ...
                    handle: function (grid) {
                        ...
                        var formOpts = {
                            ...
                            buttons: [{
                                ...
                                text: '导出专家详细评分',
                                handle: function () {
									var data = form.getFormSerialize()+"&paperId="+currentPaper+"&scoreType=3";
									App.download(App.href+"/api/core/scorePaper/exportEPScore?"+data,modal.$body)
                                }
                            },{
                                type: 'button',
								cls: "btn btn-primary",
                                text: '导出专家未评分学会名',
                                handle: function () {
									var data = "paperId="+currentPaper+"";
									App.download(App.href+"/api/core/scorePaper/exportEPNotFinished?"+data,modal.$body)
                                }
                            },{
                                type: 'button',
                                text: '关闭',
