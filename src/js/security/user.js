            ...
            actionColumns: [
                {
                    ...
                    handle: function (index, data) {
                        ...
                        var formOpts = {
                            ...
                            name: "index_form",
                            method: "POST",
                            action: App.href + "/api/sys/user/update",
                            ajaxSubmit: true,
                            ...
                            items: [
                                {
                                    ...
                                    id: 'menus',
                                    label: '功能预览',
                                    url: App.href + "/api/sys/role/functions",
                                    expandAll: true,
                                    autoParam: ["id", "name", "pId"],
                                    checkable: false
                                }
                    ...
                    handle: function (index, data) {
                        bootbox.confirm("确定该操作?", function (result) {
                            if (result) {
                                var requestUrl = App.href + "/api/sys/user/deleteCache";
                                $.ajax({
                                    type: "GET",
                                    dataType: "json",
                                    data: {
                            ...
                            items: [
                                {
                                    ...
                                    autoUpload: false,
                                    allowTypes: "xls,xlsx",
                                    uploadUrl: App.href + '/api/sys/user/import',
